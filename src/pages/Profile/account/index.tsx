...
import { getAccount, handleCancellation, handleFollow, handleUnfollow } from "../../../helpers/api"
            ...
            .then(response => {
                if(response.status == 'unfollowed'){
                    setUser({...user,
                        ...
                        followers:user?.followers?.filter(us=>us.id !== user.id )
                        })
                }
            })
        }
